...
- [x] **1.12 REFACTOR/VERIFY — Close runtime slice and JD-S1-001..009.** Run all Slice 1 commands, adversarial unit/spawn probes, static dependency and manifest-hash checks, and retain pre-start spawn/parse/timeout failures as host fail-open residuals.
