...
| 5.3 agent-skills.test.ts | DONE (S4) | 7 gate tests + 2 JD-006 validation refusals; block before fs.remove/fs.copy; skills:[]/missing refused; containment (../../, absolute); undeclared/node_modules refused; symlinked refused (force never lifts); force+unscannable proceeds; scanner throw denies; dryRun no scan; clean byte-identical |
