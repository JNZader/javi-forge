 ...
 */
export async function discoverWorkflows(projectDir: string): Promise<WorkflowDiscoveryEntry[]> {
 ...
 */
export async function listBuiltinTemplates(): Promise<WorkflowDiscoveryEntry[]> {
 ...
 */
export async function loadBuiltinTemplate(name: string): Promise<{ content: string; format: WorkflowFormat } | null> {
