...
import { discoverWorkflows, listBuiltinTemplates, loadBuiltinTemplate } from './discovery.js'
...
describe('discoverWorkflows', () => {
  ...
  it('discovers .dot and .mermaid files', async () => {
    ...
    mockedFs.readdir.mockResolvedValue(['deploy.dot', 'review.mermaid', 'notes.txt'] as never)
...
describe('listBuiltinTemplates', () => {
  ...
  it('lists .dot templates', async () => {
    mockedFs.pathExists.mockResolvedValue(true as never)
    mockedFs.readdir.mockResolvedValue(['ci-pipeline.dot', 'release.dot'] as never)
