...
export const HELP_TEXT = `
  ...
  Options
    ...
    --rollback PATH Restore an apply-scope or profile-apply backup onto the target config
...
export const HOOKS_HELP_TEXT = `
  ...
  Subcommands
    ...
    doctor opencode   Report OpenCode plugin file currency and runtime smoke (never runnable from bytes)
