import type { WorkflowGraph, WorkflowNode, WorkflowEdge } from '../../types/index.js'
 ...
 */
export function parseDot(content: string, sourceName = 'untitled'): WorkflowGraph {
 ...
 */
export function parseMermaid(content: string, sourceName = 'untitled'): WorkflowGraph {
...
function ensureNode(nodesMap: Map<string, WorkflowNode>, id: string): WorkflowNode {
